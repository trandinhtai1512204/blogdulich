    ...
    destination: [
        {
            ...
            answer: 'Việt Nam có nhiều điểm đến nổi bật như Hà Nội, Hội An, Đà Nẵng, Sa Pa, Hạ Long và Phú Quốc. Nếu thích văn hóa, hãy ưu tiên Hà Nội hoặc Hội An; nếu thích biển, Đà Nẵng và Phú Quốc là lựa chọn dễ đi.',
        },
        {
            question: 'Mùa nào thích hợp để đi du lịch miền Bắc?',
            answer: 'Khoảng tháng 9 đến tháng 11 thường là thời điểm dễ chịu nhất ở miền Bắc vì trời mát, ít mưa và cảnh quan đẹp. Mùa xuân cũng phù hợp nếu bạn muốn kết hợp lễ hội và khám phá văn hóa địa phương.',
        },
        {
            question: 'Điểm đến nào phù hợp cho du lịch gia đình?',
            answer: 'Đà Nẵng, Phú Quốc, Hà Nội và Đà Lạt thường phù hợp cho gia đình vì có nhiều lựa chọn lưu trú, ăn uống, vui chơi và di chuyển tương đối thuận tiện.',
        },
        {
            question: 'Du lịch tự túc nên chọn điểm đến nào?',
            answer: 'Hà Nội, Đà Nẵng, Hội An và Phú Quốc là những điểm đến thân thiện với khách tự túc. Các nơi này có nhiều thông tin tham khảo, dịch vụ du lịch phổ biến và phương tiện di chuyển dễ sắp xếp.',
        },
    ],
    itinerary: [
        {
            question: 'Nên lên lịch trình du lịch trước bao lâu?',
            answer: 'Với chuyến đi ngắn ngày, bạn nên lên lịch trình trước 1 đến 2 tuần. Với mùa cao điểm hoặc chuyến đi gia đình, nên chuẩn bị trước 3 đến 4 tuần để dễ đặt vé, khách sạn và tối ưu chi phí.',
        },
        {
            question: 'Một lịch trình du lịch nên có những phần nào?',
            answer: 'Một lịch trình tốt nên có điểm đến chính, thời gian di chuyển, nơi ăn ở, hoạt động từng ngày, phương án dự phòng khi mưa hoặc quá tải và ngân sách ước tính.',
        },
        {
            question: 'Có nên đi quá nhiều điểm trong một ngày không?',
            answer: 'Không nên xếp quá dày vì dễ mệt và mất thời gian di chuyển. Mỗi ngày nên chọn 2 đến 4 điểm chính, ưu tiên các điểm gần nhau để chuyến đi thoải mái hơn.',
        },
    ],
    review: [
        {
            question: 'Review trên BlogDuLich.vn có dùng để đặt dịch vụ trực tiếp không?',
            answer: 'Các bài review giúp bạn tham khảo trải nghiệm, ưu nhược điểm và bối cảnh sử dụng dịch vụ. Trước khi đặt, bạn vẫn nên kiểm tra lại giá, điều kiện hủy và thông tin mới nhất từ nhà cung cấp.',
        },
        {
            question: 'Nên đọc review du lịch như thế nào cho đúng?',
            answer: 'Hãy chú ý thời điểm trải nghiệm, ngân sách, phong cách đi và nhu cầu của người viết. Một review phù hợp nhất là review có hoàn cảnh gần với chuyến đi bạn đang lên kế hoạch.',
        },
        {
            question: 'Review khách sạn, tour và combo khác nhau ở đâu?',
            answer: 'Review khách sạn tập trung vào lưu trú, vị trí và tiện nghi; review tour nói về lịch trình và hướng dẫn; review combo thường đánh giá tổng thể vé, phòng, dịch vụ đi kèm và mức độ tiện lợi.',
        },
    ],
    experience: [
        {
            question: 'Kinh nghiệm du lịch nên đọc trước chuyến đi bao lâu?',
            answer: 'Bạn nên đọc kinh nghiệm tổng quan trước khi đặt vé và đọc lại các mẹo chi tiết trước ngày đi vài hôm để chuẩn bị hành lý, lịch trình và các lưu ý tại điểm đến.',
        },
        {
            question: 'Đi du lịch tự túc cần chuẩn bị gì?',
            answer: 'Các phần quan trọng gồm giấy tờ cá nhân, đặt phòng, phương tiện di chuyển, danh sách điểm ăn chơi, ngân sách dự phòng, thuốc cơ bản và phương án liên hệ khi cần hỗ trợ.',
        },
        {
            question: 'Làm sao để tiết kiệm chi phí du lịch?',
            answer: 'Bạn có thể đi vào ngày thường, đặt sớm, chọn khu lưu trú hợp lý, dùng phương tiện công cộng khi thuận tiện và ưu tiên trải nghiệm phù hợp thay vì xếp quá nhiều dịch vụ đắt tiền.',
        },
    ],
};
let FaqsService = class FaqsService {
    ...
    async ensureExists(id) {
        ...
        if (!faq)
            throw new common_1.NotFoundException('FAQ không tồn tại');
    }
    async resolveBuckets(query) {
    ...
    async findPublished(targetType, targetId, module) {
        return this.prisma.faq.findMany({
            where: {
                targetType,
    ...
    async categoryChain(categoryId) {
        const chain = [];
